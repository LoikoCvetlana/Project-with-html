...
public class ProductTest {
    ...
    public void checkSaveProduct() {
        Material material = new Material("Test Material", "Test description");
        ProductCreateDto productCreateDto = new ProductCreateDto
                ("TstsProduct","KP1","/KP1", BigDecimal.valueOf(100.24),material.getName());
    ...
    public void checkAllProducts() {
        ...
        Product product1 = productService.saveProduct(new ProductCreateDto
                ("TstsProduct2","KP2","/KP2", BigDecimal.valueOf(144.00),material.getName()));
        Product product2 = productService.saveProduct(new ProductCreateDto
                ("TstsProduct3","KP3","/KP3", BigDecimal.valueOf(60.00),material.getName()));
